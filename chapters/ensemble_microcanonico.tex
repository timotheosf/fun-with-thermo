...
\section{Encontrando a multiplicidade}
    ...
    \begin{example}{Multiplicidade do paramagnetno de dois estados}{micro:multiplicidade_paramagnetno_dois_estados}
        ...
        \begin{center}
            \ParamagneticSalt
            \captionof{figure}{Paramagneto de dois estados. \label{fig:paramagnetic_salt}}
        \end{center}
    ...
    \begin{example}{Multiplicidade do sólido de Einstein}{}
        ...
        \begin{center}
            ...
            \captionof{figure}{Sólido de Einstein: `caixas' contendo osciladores independentes um do outro -- isto é, a energia de um não interfere na do outro.\label{fig:EinsteinSolid}}
        \end{center}
        ...
        Para descobrirmos a multiplicidade, vamos recorrer à estratégia de tentar `montar' um sistema a partir \textit{ex nihilo}. Empilhamos nossos $M$ múltiplos de energia e enfileiramos os $N$ osciladores (que ocuparão exatamente $N$ lugares na rede do sólido). Fazemos o seguinte processo:
        \begin{enumerate}
        ...
        \begin{center}
            ...
            \captionof{figure}{Processo de construção do sólido de Einstein.
            \label{fig:EinsteinSolidMultiplicity}}
        \end{center}
