...
\subsection{Temperatura e funções resposta}
    ...
    \begin{solved}{Temperatura no Paramagneto de dois estados}{}
        ...
        \PlotFig[%
            xlabel={Energia $\ppu\,\,(\upmu_m\mathrm{H})$},
            ylabel={$1/T\,\,(k_B/\upmu_m\mathrm{H})$},
            domain=-0.999:0.999,
            width=0.58\linewidth]
            {-ln((1+x)/(1-x))}
            [MediumRed]
        \caption{À esquerda, a entropia em função da energia $\ppu$ (em unidades de $\upmu_m\mathrm{H}$); à direita, a temperatura em função da energia $\ppu$ (em unidades de $\upmu_m\mathrm{H}$).}
        \end{center}
