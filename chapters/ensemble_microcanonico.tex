...
\subsection{Temperatura e funções resposta}
    ...
    \begin{solved}{Potencial químico no Gás de Rede}{}
        ...
        \[\frac{\mu}{T} = \pderivative{S}{N}[V] = k_B\ln(\ppv-1)\,. \]
        
        Veja que o sinal de $\mu$ muda em $\ppv=2$. Com efeito, caso tivermos $\ppv<2$, isto é, se metade dos $V$ retículos já tiverem ocupados, \[N\geq \frac{V}{2}\,,\] $\mu < 0$ e a colocação de novas moléculas de gás resultaria em aumento de entropia. De outra parte, caso for $\ppv>2$ ($N\leq V/2$), a adição de novas moléculas \textit{reduz} a entropia do sistema!
        ...
        \[\frac{p}{T} = \pderivative{\pps}{\ppv} = k_B\left(\frac{1}{\ppv-1}-\ln\left(1-\frac{1}{\ppv}\right)-\frac{1}{v-1}\right) = -k_B\ln\left(1-\frac{1}{v}\right)\,.\]
        Finalmente, no limite de gás de baixa densidade ($\ppv\gg 1$), temos
        \[\frac{p}{T}\approx = k_B \ppv \Longrightarrow pV=k_BNT\,,\]
